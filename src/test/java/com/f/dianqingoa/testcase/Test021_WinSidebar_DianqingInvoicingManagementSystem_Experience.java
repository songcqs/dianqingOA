...
public class Test021_WinSidebar_DianqingInvoicingManagementSystem_Experience extends CaseBase {
...
//	@Test(priority = 21)
	 ...
	 * 18.2鼠标悬停"点晴进销存管理系统"
	 */
//	@Test(priority = 21, dependsOnMethods = "dianqings_Way_of_Management")
	@Test(priority = 21, description="悬停\"点晴进销存管理系统\"")
	 ...
	 */
	@Test(priority = 21,description="点击\"点晴进销存管理系统\"页\"立即体验\"", dependsOnMethods = "winLeft_Invoicing_management_system")
//	@Test(priority = 21)
