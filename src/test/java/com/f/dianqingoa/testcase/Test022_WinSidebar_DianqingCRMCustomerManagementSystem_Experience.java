...
public class Test022_WinSidebar_DianqingCRMCustomerManagementSystem_Experience extends CaseBase {
...
//	@Test(priority = 22)
	 ...
	 */
//	@Test(priority = 22,description="悬停\"点晴CRM客户管理系统\"", dependsOnMethods = "dianqings_Way_of_Management")
	@Test(priority = 22,description="悬停\"点晴CRM客户管理系统\"")
	 ...
	 */
	@Test(priority = 22,description="点击\"点晴CRM客户管理系统\"页\"立即体验\"", dependsOnMethods = "winLeft_Customer_Management_System")
//	@Test(priority = 22)
