...
public class Test023_WinSidebar_DianqingAllStaffAttendance_Experience extends CaseBase {
...
//	@Test(priority = 23)
	 ...
	 * 18.4鼠标悬停"点晴全员考勤解决方案"
	 */
//	@Test(priority = 23, dependsOnMethods = "dianqings_Way_of_Management")
	@Test(priority = 23, description="悬停\"点晴全员考勤解决方案\"")
	 ...
	 */
	@Test(priority = 23,description="点击\"点晴全员考勤解决方案\"页\"立即体验\"", dependsOnMethods = "winLeft_Solution_of_full_attendance")
//	@Test(priority = 23)
