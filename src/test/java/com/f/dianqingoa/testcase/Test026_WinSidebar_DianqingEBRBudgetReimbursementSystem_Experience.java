...
public class Test026_WinSidebar_DianqingEBRBudgetReimbursementSystem_Experience extends CaseBase {
...
//	@Test(priority = 26)
	 ...
	 */
//	@Test(priority = 26, dependsOnMethods = "dianqings_Way_of_Management")
	@Test(priority = 26, description="悬停\"点晴EBR预算报销系统\"")
	 ...
	 */
	@Test(priority = 26,description="点击\"点晴EBR预算报销系统\"页\"立即体验\"",dependsOnMethods = "winLeft_Budget_reimbursement_system")
//	@Test(priority = 26)
