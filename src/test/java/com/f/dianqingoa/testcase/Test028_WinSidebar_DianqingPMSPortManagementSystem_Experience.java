...
public class Test028_WinSidebar_DianqingPMSPortManagementSystem_Experience extends CaseBase {
...
//	@Test(priority = 28)
	 ...
	 */
//	@Test(priority = 28, dependsOnMethods = "dianqings_Way_of_Management")
	@Test(priority = 28, description="悬停\"点晴PMS港口管理理系统\"")
	 ...
	 */
	@Test(priority = 28,description="点击\"点晴PMS港口管理系统\"页\"立即体验\"",dependsOnMethods = "winLeft_Port_Management_System")
//	@Test(priority = 28)
