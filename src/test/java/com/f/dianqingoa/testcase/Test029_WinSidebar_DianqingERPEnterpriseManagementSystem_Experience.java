...
public class Test029_WinSidebar_DianqingERPEnterpriseManagementSystem_Experience extends CaseBase {
...
//		driverBase.switchToFrame(hompageEle.getLeftIframe());
	 ...
	 * 18.点击"点睛管理之道"
	 */
//	@Test(priority = 29,description="点击\"点睛管理之道\"")
	 ...
	 */
	@Test(priority = 29,description="鼠标悬停\"点晴ERP企业管理系统\"")
//	@Test(priority = 29)
	 ...
	 */
	@Test(priority = 29, description="点击\"点晴ERP企业管理系统\"页\"立即体验\"",dependsOnMethods = "winLeft_Enterprise_Management_System")
//	@Test(priority = 29)
